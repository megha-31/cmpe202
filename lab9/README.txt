...
Choosing a sorting algorithm dynamically at runtime demonstrates Strategy Pattern as the approach can be changed to accomplish the same end result, i.e, Sorted list
